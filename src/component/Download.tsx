...
const Download = () => {
  const downloadablePdfs = [
  {
    ...
    url: '/assets/pdfs/Affiliation.pdf', // Placeholder URL
  ...
  {
    name: 'Training Fee',
    url: '/assets/pdfs/Normative Training Fee for Private ITIs.pdf',
  ...
  },
  {
    ...
    url: '/assets/pdfs/Circular on DDGM AND GRADING SCORES 2025.pdf',
